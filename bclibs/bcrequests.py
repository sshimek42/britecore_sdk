...
token_class = OAuthToken(
    site_settings.client_id, site_settings.client_secret,
    base_url
    )
...
def store_mortgagee(
    property_contact_id: str, mortgagee_contact_id: str,
    **kwargs
    ):
    store_mort_json = {
...
def get_tb_list(from_date, to_date, **kwargs):
    ...
    result_request = do_request(
        ...
        json=required_json, request_timeout=request_timeout,
        request_retries=request_retries, **kwargs
        )
