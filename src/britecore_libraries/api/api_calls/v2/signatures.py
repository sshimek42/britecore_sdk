"""BriteCore signatures API stubs (generated from britecore_api.json).
...
UNIMPLEMENTED_CALLS: Final[dict[str, str]] = {
    "docusign_auth": "/api/v2/signatures/docusign_auth",
    "docusign_config": "/api/v2/signatures/docusign_config",
    "get_signatures": "/api/v2/signatures/get_signatures",
    "recreate_envelope": "/api/v2/signatures/recreate_envelope",
    "update_signatures": "/api/v2/signatures/update_signatures",
    "void_envelope": "/api/v2/signatures/void_envelope",
}
