"""BriteCore printing API stubs (generated from britecore_api.json).
...
UNIMPLEMENTED_CALLS: Final[dict[str, str]] = {
    "getattachment": "/api/v1/printing/getAttachment",
    "gettobeprinted": "/api/v1/printing/getToBePrinted",
    "markasprinted": "/api/v1/printing/markAsPrinted",
    "sendprinthawk": "/api/v1/printing/sendPrintHawk",
