"""BriteCore custom_ui API stubs (generated from britecore_api.json).
...
UNIMPLEMENTED_CALLS: Final[dict[str, str]] = {
    "createurloverride": "/api/v1/custom_ui/createURLOverride",
    "deleteurloverride": "/api/v1/custom_ui/deleteURLOverride",
    "retrieveurloverrides": "/api/v1/custom_ui/retrieveURLOverrides",
    "updateurloverride": "/api/v1/custom_ui/updateURLOverride",
}
