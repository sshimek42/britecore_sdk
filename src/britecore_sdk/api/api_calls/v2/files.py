...
def generate_download_url(
    ...
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/files/generate_download_url``."""
    ...
    return _api_client.process_result(request_result, endpoint="/api/v2/files/generate_download_url")
...
def retrieve_active_file_objects(
    ...
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/files/retrieve_active_file_objects``."""
    from britecore_sdk.api.api_calls import api_client as _api_client
    ...
    return _api_client.process_result(request_result, endpoint="/api/v2/files/retrieve_active_file_objects")
