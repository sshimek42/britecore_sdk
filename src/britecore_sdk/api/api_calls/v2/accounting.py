...
def export_account_histories(
    ...
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/accounting/export_account_histories``."""
    request_json: dict[str, Any] = {
...
def retrieve_outstanding_invoices(
    ...
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/accounting/retrieve_outstanding_invoices``."""
    request_json: dict[str, Any] = {
...
def set_return_premium_to_export(
    ...
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/accounting/set_return_premium_to_export``."""
