...
def approve_pending_payment(
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/payments/approve_pending_payment``."""
...
def create_recurring_payment_consent(
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/payments/create_recurring_payment_consent``."""
    request_json: dict[str, Any] = {}
    filtered_json = {k: v for k, v in request_json.items() if v is not None}
    request_result = API_CLIENT.do_request(
...
def decline_pending_payment(
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/payments/decline_pending_payment``."""
    request_json: dict[str, Any] = {}
    filtered_json = {k: v for k, v in request_json.items() if v is not None}
    request_result = API_CLIENT.do_request(
...
def import_payment_method(
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/payments/import_payment_method``."""
    request_json: dict[str, Any] = {}
    filtered_json = {k: v for k, v in request_json.items() if v is not None}
    request_result = API_CLIENT.do_request(
...
def retrieve_active_payment_processor(
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/payments/retrieve_active_payment_processor``."""
    request_json: dict[str, Any] = {}
    filtered_json = {k: v for k, v in request_json.items() if v is not None}
    request_result = API_CLIENT.do_request(
...
def retrieve_payment_method_consent(
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/payments/retrieve_payment_method_consent``."""
    request_json: dict[str, Any] = {}
    filtered_json = {k: v for k, v in request_json.items() if v is not None}
    request_result = API_CLIENT.do_request(
...
def retrieve_payment_method_creation_details(
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/payments/retrieve_payment_method_creation_details``."""
    request_json: dict[str, Any] = {}
    filtered_json = {k: v for k, v in request_json.items() if v is not None}
    request_result = API_CLIENT.do_request(
...
def retrieve_pending_payments_for_settlement(
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/payments/retrieve_pending_payments_for_settlement``."""
    request_json: dict[str, Any] = {}
    filtered_json = {k: v for k, v in request_json.items() if v is not None}
    request_result = API_CLIENT.do_request(
...
def settle_payments(
    ...
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/payments/settle_payments``."""
    request_json: dict[str, Any] = {
        "payments": payments,
    }
    filtered_json = {k: v for k, v in request_json.items() if v is not None}
...
def store_external_payment(
    ...
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/payments/store_external_payment``."""
    request_json: dict[str, Any] = {
...
def store_payment(
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/payments/store_payment``."""
    request_json: dict[str, Any] = {}
    filtered_json = {k: v for k, v in request_json.items() if v is not None}
    request_result = API_CLIENT.do_request(
...
def store_payment_nsf(
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/payments/store_payment_nsf``."""
    request_json: dict[str, Any] = {}
    filtered_json = {k: v for k, v in request_json.items() if v is not None}
    request_result = API_CLIENT.do_request(
