...
def find_similar_contact(
    ...
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/insured/find_similar_contact``."""
...
def get_contacts_with_insured_portal_user_role(
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/insured/get_contacts_with_insured_portal_user_role``."""
    from britecore_sdk.api.api_calls import api_client as _api_client
