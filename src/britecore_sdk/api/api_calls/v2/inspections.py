...
def initiate_property_inspection(
    ...
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/inspections/initiate_property_inspection``."""
...
def update_property_inspection_data(
    ...
    **kwargs: Unpack[RequestParameters],
    ...
    """Autogenerated wrapper for ``POST /api/v2/inspections/update_property_inspection_data``."""
    request_json: dict[str, Any] = {
