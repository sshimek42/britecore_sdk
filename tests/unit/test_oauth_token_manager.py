...
class TestOAuthTokenRequest:
    ...
    @pytest.mark.unit
    @patch("britecore_libraries.api.britecore_oauth_token_manager.http")
    def test_request_new_token_failure_no_existing_token(self, mock_http, mock_oauth_response_error):
    ...
    @pytest.mark.unit
    @patch("britecore_libraries.api.britecore_oauth_token_manager.http")
    def test_request_new_token_failure_with_existing_token(self, mock_http, mock_oauth_response_error):
...
class TestOAuthTokenHeaders:
    ...
    @pytest.mark.unit
    @patch("britecore_libraries.api.britecore_oauth_token_manager.http")
    def test_get_authorization_headers_triggers_refresh(self, mock_http, mock_oauth_response):
