...
We as contributors, maintainers, and community members pledge to make participation in the
`britecore_sdk` project a harassment-free experience for everyone, regardless of age, body size,
...
Project spaces include, but are not limited to:

- GitHub issues
- Pull requests and code review discussions
- GitHub Discussions
- Documentation, examples, and project support channels
...
- Links or references to the relevant discussion, pull request, issue, or commit
- When and where the incident occurred
- Any other context that may help with review
...
Community impact will guide the consequences for any action deemed in violation of this Code of
Conduct.
...
**Consequence:** A private, written warning from maintainers, providing clarity around the nature
...
sustained inappropriate behavior, harassment of an individual, or aggression toward or disparaging
