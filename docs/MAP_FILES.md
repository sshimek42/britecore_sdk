...
> `britecore_libraries`**. Only generic/common mapping utilities remain in this package.
...
Mapping data (such as agency, field, or policy type mappings) is no longer included in `britecore_libraries`.
